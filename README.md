...
<div align="center">
  ...
  -->
	...
	<a href="https://www.postgresql.org/" target="_blank"><img style="margin: 10px" src="https://profilinator.rishav.dev/skills-assets/postgresql-original-wordmark.svg" alt="PostgreSQL" height="52" /></a>
...
Django-based web application developed to help Peruvian businesses create, manage, and track professional quotes end to end, with integrated PDF generation, SUNAT RUC consultation, and work project management. The system provides a full quote workflow with CRUD operations, automatic sequential quote numbering, configurable IGV tax calculations, status tracking (from Draft to Completed), and rich client profiles including RUC, contact data, and addresses. It also includes a company profile module where users can store branding elements like logos, contact details, banking information, and sales advisors, all of which are integrated into the generated PDFs. For validation and data accuracy, I integrated real-time consultation of the SUNAT database to validate client RUCs and automatically retrieve company and legal representative information. Quotes can be previewed in the browser and exported as professional, multi-page PDFs using HTML/CSS templates optimized for A4, with proper margins, typography, logo placement, and support for both download and in-browser viewing. When a quote is approved, the application automatically creates a linked work project with its own project numbering scheme (PROJ-YYYY-NNN), allowing users to monitor project status, key dates, and estimated vs. actual hours through a dedicated project tracking interface. On the frontend, the app offers a responsive web UI built with HTML, CSS, and JavaScript, featuring dynamic forms for adding and removing line items, modal previews, and intuitive navigation between quotes, company settings, and projects. The backend is built with Django 5, uses SQLite/PostgreSQL/MySQL as needed, and exposes clear URL-based endpoints for working with quotes, PDFs, SUNAT consultation, and projects, making it a solid foundation for future enhancements like email delivery of quotes, REST APIs, advanced reporting, authentication and permissions, invoice management, and payment integrations.

https://github.com/user-attachments/assets/a447d24e-993b-4173-945b-3a17a18d6b2a



## Supplier Management System and Product Catalog
A complete web application built with Django 5.2, SQLite, and a frontend in HTML, CSS, and vanilla JavaScript, using Tabler UI to achieve a modern and responsive interface. The system allows you to manage the entire information cycle related to suppliers, products, and their variants: from creating, editing, and deleting suppliers with complete contact details and internal notes, to associating products with each supplier with categories and detailed descriptions. For each product, multiple variants can be defined with precise specifications such as size, material, finish, price, and delivery time, as well as attaching files (contracts, technical data sheets, images, etc.) using a file upload and management system. It includes a main dashboard with global statistics and recent activity, as well as a search section and advanced filters that allow products to be located by name, category, supplier, material, price range, and delivery time. Based on these results, the user can select up to 10 variants and compare them in an interactive table that facilitates decision-making. In terms of architecture, the project follows Django's MVC pattern, with well-defined models (Supplier, Product, Variant, FileAttachment), frontend and backend data validation (positive prices, non-negative delivery times, valid emails), and a system of reusable and maintainable templates written entirely in neutral Spanish for the interface, while the backend code is kept in English in accordance with best practices.

<img src="https://github.com/user-attachments/assets/481cbfd6-df31-4c1a-8fd3-98f3ae4b2c90" style="width:100%; height:auto;">
...
https://github.com/user-attachments/assets/1e91ae96-8c99-4867-a0c1-b0aaed0bd834
...
<img src="https://github.com/user-attachments/assets/8270fcab-7f04-46b8-8c03-f35b80f1f409" style="width:100%; height:auto;">
-->
<img src="https://github.com/user-attachments/assets/e3c8edf8-58dc-446c-94dd-a25308f7f1b3" style="width:100%; height:auto;">
...
A Django-based purchasing and invoicing webapp with product, supplier, and client management. It integrates user authentication, REST APIs, and a central admin panel to handle transactions and track stock in real-time.
